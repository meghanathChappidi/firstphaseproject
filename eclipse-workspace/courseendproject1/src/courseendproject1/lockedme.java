...
public class lockedme {
	...
	public static void main(String[] args) {
		...
		File directory = new File("C:\\Users\\chapp\\result//");
		...
		System.out.println("*****************************************");
		System.out.println("******* Meghanatha reddy  *********************");
		...
		do {
			...
			case 1:
				...
				try {
					File file = new File("C:\\Users\\chapp\\result//" + filename + ".txt");
			...
			case 3:
				...
				File directory_delete = new File("C:\\Users\\chapp\\result//");

				String[] flist_delete = directory_delete.list();

				// String[] fist = directory.list();
				int flag_d = 0;
				if (flist_delete == null) {
					...
					for (int i = 0; i < flist_delete.length; i++) {
						...
						if (delete_filename.equalsIgnoreCase(filename)) {
							...
							File file = new File(
									"C:\\Users\\chapp\\result//" + delete_filename);
							if (file.delete()) {
			...
			case 4:
				...
				File directory_search = new File("C:\\Users\\chapp\\result//");
	...
	private static void listOfFiles() {
		...
		File folder = new File("C:\\Users\\chapp\\result//");
